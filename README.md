...
Clone the repo into your computer. Navigate to the directory and ran an (npm i) to install all needed dependcies and run (npm run watch) to start the program. In your browser head to (localhost:3001) to use the program. You can also use this project by heading over to the website running on heroku her (https://tech-blog-du.herokuapp.com/).
